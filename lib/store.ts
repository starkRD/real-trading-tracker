...
export const capital=()=>Number(localStorage.getItem('rtt_capital')||300000); export const saveCapital=(n:number)=>localStorage.setItem('rtt_capital',String(n)); export const reset=()=>[M,A,'rtt_capital'].forEach(k=>localStorage.removeItem(k));
